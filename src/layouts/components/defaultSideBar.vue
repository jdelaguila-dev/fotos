      ...
      <router-link :to="{ name: 'upload' }">
        <li>
          ...
          >
            ...
            <span class="flex-1 ml-3 whitespace-nowrap text-black">Subir</span>
          </a>
        </li>
      </router-link>
      <router-link :to="{ name: 'todo' }">
        <li>
          ...
          >
            ...
            <span class="flex-1 ml-3 whitespace-nowrap text-black">Todos</span>
          </a>
        </li>
      </router-link>
      <router-link :to="{ name: 'profile' }">
        <li>
          ...
          >
            ...
            <span class="flex-1 ml-3 whitespace-nowrap text-black">Perfiles</span>
          </a>
        </li>
      </router-link>
    </ul>
